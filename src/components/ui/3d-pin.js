    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2 flex items-start justify-start overflow-hidden rounded-2xl bg-zinc-900/75 p-4 shadow-[0_8px_16px_rgb(0_0_0/0.4)] backdrop-blur-sm transition duration-700 group-hover/pin:border-white/[0.2]"
        >
...
export const PinPerspective = ({ title }) => {
  return (
    <motion.div className="pointer-events-none z-[60] flex h-80 w-96 items-center justify-center opacity-0 transition duration-500 group-hover/pin:opacity-100">
      <div className="relative inset-0 -mt-7 h-full w-full flex-none">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <div className="relative z-10 flex items-center space-x-2 rounded-full bg-zinc-900/75 px-4 py-0.5 ring-1 ring-white/10 backdrop-blur-sm">
            <span className="relative z-20 inline-block py-0.5 font-head text-sm font-bold uppercase">
              {title}
            </span>
